...
void UCIEngine::loop() {
    ...
    do
    {
        ...
        else if (token == "export_net")
        {
            ...
            sync_cout
              << "\nMrCorpt is a powerful chess engine for playing and analyzing."
                 "\nIt is released as free software licensed under the GNU GPLv3 License."
                 "\nMrCorpt is normally used with a graphical user interface (GUI) and implements"
                 "\nthe Universal Chess Interface (UCI) protocol to communicate with a GUI, an API, etc."
                 "\nFor any further information, visit https://github.com/mrcorpt100010010/MrCorpt#readme"
...
WinRateParams win_rate_params(const Position& pos) {
    ...
    // Return a = p_a(material) and b = p_b(material), see github.com/mrcorpt100010010/WDL_model
